...
const StyledForm = ({ isLogin = true, onToggleMode }: StyledFormProps) => {
  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      <div className="bg-gray-900/70 backdrop-blur-md rounded-xl p-8 border border-gray-700/50 shadow-2xl">
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-xs text-gray-500">Login with social accounts</span>
          <div className="h-px bg-gray-600/50 flex-1" />
        </div>
        ...
        <div className="flex justify-center gap-3">
          <button
            ...
            className="p-2.5 rounded-lg border border-gray-600/50 bg-gray-800/50 hover:bg-gray-700/50 transition-colors"
          >
