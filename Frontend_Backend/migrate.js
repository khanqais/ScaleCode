...
async function migrateUserId() {
  ...
  try {
    ...
    const oldUserId = "user_31xUt1q5rPAglWoKMkihsZxOLoC"; // Old Clerk ID from your screenshot
    const newUserId = "68cfca9dcd7967dca6ed5554"; // New NextAuth ID from your screenshot
